...
class Ui_homePage(object):
    def setupUi(self, homePage):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 340, 505))
        ...
        self.enterCalculatePage = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.enterCalculatePage.setObjectName("enterCalculatePage")
        self.settingsDisplay.addWidget(self.enterCalculatePage)
    ...
    def retranslateUi(self, homePage):
        ...
        self.enterCalculatePage.setText(_translate("homePage", "Calculate"))
